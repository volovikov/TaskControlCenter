define([
  ...
  'text!./templates/wholesale-crm-count-call.html',
  ...
  var public = {
    myModuleName: 'WholesaleCrmStatCountCallModule',
    gridPageSize: 20,
    defaultPeriod: {
      dateBegin: null,
      timeBegin: null,
      ...
      return new kendo.data.DataSource({
        transport: {
          read: function (options) {
            $.ajax({
              url: app.wholesaleServerUrl + 'crm.php?method=get-count-call-by-prefix',
              type: 'post',
              data: {
