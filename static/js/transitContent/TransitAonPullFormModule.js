define([
  ...
  'text!./templates/transit-aon-pull-form.html',
  ...
  var public = {
    myModuleName: 'TransitAonPullFormModule',
    gridPageSize: 20,
    run: function (params) {
  ...
  var private = {
    bindEvents: function () {
      ...
      $(document).off('click', '#aon-pull-form-submit-btn').on('click', '#aon-pull-form-submit-btn', function (e) {
        e.preventDefault();
    ...
    getDataSource: function () {
      ...
      return new kendo.data.DataSource({
        transport: {
          read: function (options) {
            $.ajax({
              url: app.transitServerUrl + 'aon.php?method=get-pull-number',
              type: 'post',
              data: {
          ...
          create: function (options) {
            ...
            $.ajax({
              url: app.transitServerUrl + 'aon.php?method=add-number',
              type: 'post',
              data: data,
              success: function (resp) {
                var r = JSON.parse(resp);
                if (r.success) {
                  data.numberId = r.data.numberId;
                  options.success({data: data});
                  app.publish('add-number', data);
                }
              }
            });
          },
          update: function (options) {
            ...
            $.ajax({
              url: app.transitServerUrl + 'aon.php?method=set-number',
              type: 'post',
              data: data,
              success: function (resp) {
                var r = JSON.parse(resp);
                if (r.success) {
                  options.success({data: data});
                  app.publish('update-number', data);
                }
              }
            });
          },
          destroy: function (options) {
            ...
            $.ajax({
              url: app.transitServerUrl + 'aon.php?method=del-number',
              type: 'post',
              data: data,
              success: function (resp) {
                var r = JSON.parse(resp);
