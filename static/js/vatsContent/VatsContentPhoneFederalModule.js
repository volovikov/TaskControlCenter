define([
    ...
    'text!./templates/vats-phone-federal.html',
], function($, k, u, common, local, vatsPhoneFederal) {
    
    var vatsPhoneFederalTmpl = k.template(vatsPhoneFederal);
    
    var public = {        
        myModuleName: 'VatsContentPhoneFederalModule',
        run: function(params) {
    ...
    var private = {
        ...
        renderFedaralPhoneTable: function() {
            ...
            this.el.find('#phone-federal').kendoGrid({
                columns: [{
                    field: 'phoneId',
                    title: 'id',
                    width: '50px'
