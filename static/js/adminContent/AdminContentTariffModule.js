...
define([
    ...
    'text!./templates/admin-tariff-form.html',
    'css!./css/adminContent'
], function($, k, u, common, local, adminTariffForm) {
    
    var adminTariffFormTmpl = k.template(adminTariffForm);
    
    var public = {        
        myModuleName: 'AdminContentTariffModule',
        run: function(params) {
