...
define([
    ...
    'text!./templates/admin-tariff-statistic.html',
    'css!./css/adminContent'
], function($, k, u, common, local, adminTariffStatistic) {
    
    var adminTariffStatisticTmpl = k.template(adminTariffStatistic);
    
    var public = {        
        myModuleName: 'AdminContentTariffStatisticModule',
        run: function(params) {
