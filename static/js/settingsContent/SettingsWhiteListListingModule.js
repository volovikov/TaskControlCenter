define([
    ...
    'text!./templates/settings-whitelist-listing.html',
    'css!./css/settingsContent'
], function($, k, u, common, local, whiteList) {
    
    var whiteListTmpl = k.template(whiteList);
    
    var public = {
        myModuleName: 'SettingsWhiteListListingModule',
        run: function(params) {
    ...
    var private = {
        ...
        renderServersTable: function() {
            this.el.find('#whitelist-listing').kendoGrid({
                columns: [{
                    field: 'number',    
                    title: 'Номер'
                }],                
