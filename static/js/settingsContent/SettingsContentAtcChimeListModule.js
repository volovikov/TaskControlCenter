define([
    ...
    'text!./templates/settings-property-atc-chime-list.html',
    ...
    var public = {
        myModuleName: 'SettingsContentAtcChimeListModule',
        run: function(params) {
                    ...
                    destroy: function(options) {
                        $.ajax({
                            ...
                            success: function(resp) {
                                ...
                                if (r.success) {
                                    options.success(r);
                                    app.publish('del-atc-chime', options.data.models[0].chimeId);
                                } else {
                                    options.error();
                                }                                    
                            }
