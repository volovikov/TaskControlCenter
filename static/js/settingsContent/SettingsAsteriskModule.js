define([
    ...
    'text!./templates/settings-property-asterisk.html',
    ...
    var public = {
        myModuleName: 'SettingsAsteriskModule',
        defaultOffset: 1,
    ...
    var private = {
        ...
        setAsteriskWatchOn: function(asteriskId) {
            ...
            requirejs(['js/settingsContent/data/asterisk-free-fill-list'], function(list) {
